let path,fs,promisify,routes,cloneDeep,inlineScriptChecksum,sapperInlineScriptChecksums;_801‍.w("path",[["default",["path"],function(v){path=v}]]);_801‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_801‍.w("util",[["promisify",["promisify"],function(v){promisify=v}]]);_801‍.w("../__sapper__/service-worker",[["routes",["routes"],function(v){routes=v}]]);_801‍.w("lodash-es/cloneDeep",[["default",["cloneDeep"],function(v){cloneDeep=v}]]);_801‍.w("../src/inline-script/checksum",[["default",["inlineScriptChecksum"],function(v){inlineScriptChecksum=v}]]);_801‍.w("../src/server/sapperInlineScriptChecksums",[["sapperInlineScriptChecksums",["sapperInlineScriptChecksums"],function(v){sapperInlineScriptChecksums=v}]]);// create the vercel.json file
