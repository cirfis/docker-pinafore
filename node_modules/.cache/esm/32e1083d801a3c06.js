let path,fs,promisify,LOCALE,getIntl,trimWhitespace;_801‍.w("path",[["default",["path"],function(v){path=v}]]);_801‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_801‍.w("util",[["promisify",["promisify"],function(v){promisify=v}]]);_801‍.w("../src/routes/_static/intl",[["LOCALE",["LOCALE"],function(v){LOCALE=v}]]);_801‍.w("./getIntl",[["getIntl",["getIntl"],function(v){getIntl=v}],["trimWhitespace",["trimWhitespace"],function(v){trimWhitespace=v}]]);
